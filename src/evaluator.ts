...
import type{AreaId,ComponentEvaluation}from"./types.js";
...
export function getSecurityResult(score:number,evaluations:ComponentEvaluation[]):string{
  if(score>=95&&meetsPostZeroTrustRequirements(evaluations))return"Post-Zero Trust";
...
function meetsPostZeroTrustRequirements(evaluations:ComponentEvaluation[]):boolean{
