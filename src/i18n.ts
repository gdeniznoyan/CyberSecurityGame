...
const turkishTranslations:Record<string,string>={
  ...
  "Analyze the architecture to identify it.":"Mimariyi tanımlamak için analiz edin.",
  "Exact predefined architecture match.":"Önceden tanımlanmış mimariyle tam eşleşme.",
  "This component combination is not a predefined architecture.":"Bu bileşen birleşimi önceden tanımlanmış bir mimari değildir.",
  "Custom Architecture":"Özel Mimari",
  "Unprotected System":"Korumasız Sistem",
  "VPN-Based System":"VPN Tabanlı Sistem",
  "Zero Trust Architecture":"Sıfır Güven Mimarisi",
  "Post-Zero Trust Architecture":"Sıfır Güven Sonrası Mimari",
  ...
  "Basic password authentication with no network protection or encryption.":"Ağ koruması veya şifreleme olmadan temel parola doğrulaması kullanır.",
  "Uses a VPN tunnel and firewall to provide secure remote access to the corporate network.":"Kurumsal ağa güvenli uzaktan erişim sağlamak için VPN tüneli ve güvenlik duvarı kullanır.",
  "Every access request is verified using identity, endpoint protection and security policies.":"Her erişim isteği kimlik, uç nokta koruması ve güvenlik politikaları kullanılarak doğrulanır.",
  "Combines strong authentication, policy-based access and advanced security controls for maximum protection.":"En yüksek koruma için güçlü kimlik doğrulama, politika tabanlı erişim ve gelişmiş güvenlik kontrollerini birleştirir.",
  "Languages":"Diller",
