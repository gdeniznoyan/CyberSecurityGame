...
const turkishTranslations:Record<string,string>={
  ...
  "3. Analyze your architecture.":"3. Mimarinizi analiz edin.",
  "4. Improve and build securely.":"4. Geliştirin ve güvenli şekilde oluşturun.",
  ...
  "Score will appear after analysis.":"Puan analizden sonra görünecek.",
  "Score Levels":"Puan Seviyeleri",
  "Very Low":"Çok Düşük",
  "Low":"Düşük",
  "Medium":"Orta",
  "Good":"İyi",
  "High":"Yüksek",
  "Advanced":"Gelişmiş",
  "Very Low Security":"Çok Düşük Güvenlik",
  "Low Security":"Düşük Güvenlik",
  "Medium Security":"Orta Güvenlik",
  "Good Security":"İyi Güvenlik",
  "High Security":"Yüksek Güvenlik",
  ...
  "Security score levels":"Güvenlik puanı seviyeleri",
  ...
  "Client Component":"İstemci Bileşeni",
  "Authentication Component":"Kimlik Doğrulama Bileşeni",
  "Internet Component":"İnternet Bileşeni",
  "Third-Party Service":"Üçüncü Taraf Hizmeti",
  "Security Control":"Güvenlik Kontrolü",
  "Drop one client component":"Bir istemci bileşeni bırakın",
  "Drop one authentication component":"Bir kimlik doğrulama bileşeni bırakın",
  "Drop one connection component":"Bir bağlantı bileşeni bırakın",
  "Drop one third-party service":"Bir üçüncü taraf hizmeti bırakın",
  "Drop one security component":"Bir güvenlik bileşeni bırakın",
  "Drop Target Network Here":"Hedef Ağı Buraya Bırakın",
  ...
  "Private Virtual Network":"Özel Sanal Ağ",
  "Local Network":"Yerel Ağ",
  "Public Network":"Herkese Açık Ağ",
  "illustration":"görseli",
  "Password-based authentication component.":"Parola tabanlı kimlik doğrulama bileşeni.",
  "Multi-factor authentication component.":"Çok faktörlü kimlik doğrulama bileşeni.",
  "Biometric authentication component.":"Biyometrik kimlik doğrulama bileşeni.",
  "Certificate-based authentication component.":"Sertifika tabanlı kimlik doğrulama bileşeni.",
  ...
  "Encrypted communication.":"Şifrelenmiş iletişim.",
  "Controlled resource access.":"Kontrollü kaynak erişimi.",
  "Protection for data in memory.":"Bellekteki veriler için koruma.",
  "External identity provider.":"Harici kimlik sağlayıcı.",
  "External cloud service.":"Harici bulut hizmeti.",
  "External application programming interface.":"Harici uygulama programlama arayüzü.",
  "External VPN service provider.":"Harici VPN hizmet sağlayıcısı.",
  "Domain name service.":"Alan adı hizmeti.",
  ...
  "Certificate issuer and validator.":"Sertifika yayınlayıcı ve doğrulayıcı.",
  "Private corporate target.":"Özel kurumsal hedef.",
  "Private virtual target.":"Özel sanal hedef.",
