...
const icon = (id: string): string =>
  `./assets/component-icons-raster/${id}.png?v=10`;
...
) => ({ id, label, type: "select" as const, defaultValue, options });

export const clientDeviceComponent: ComponentDefinition = {
  id: "client-device",
  name: "Client Device",
  area: "user-device",
  description:
    "Represents the endpoint device used by the user to initiate access. The device may be a personal computer, BYOD device, or another endpoint that is not automatically trusted.",
...
export const secureDeviceComponent: ComponentDefinition = {
  id: "secure-device",
  name: "Secure Device",
  area: "user-device",
  description:
    "Represents a managed and security-controlled endpoint that meets the organization's security requirements before accessing protected resources.",
...
export const saytrustHardwareSecurityTokenComponent: ComponentDefinition = {
  id: "saytrust-hardware-security-token",
  name: "sayTRUST Hardware Security Token",
  area: "user-device",
  description:
    "Represents the sayTRUST hardware-based security token used to provide hardware-bound identity and protect sensitive authentication and cryptographic operations outside the client device.",
...
export const biometricVerificationComponent: ComponentDefinition = {
  id: "biometric-verification",
  name: "Biometric Verification",
  area: "user-device",
  description:
    "Uses a biometric characteristic such as a fingerprint or facial feature to verify that the person requesting access is the authorized user.",
...
export const clientPinComponent: ComponentDefinition = {
  id: "client-pin",
  name: "Client PIN",
  area: "user-device",
  description:
    "Represents a PIN known by the user and used as an additional authentication factor when accessing the secure client or hardware token.",
...
export const privateCaComponent: ComponentDefinition = {
  ...
  area: "identity-route",
  description:
    "Represents an organization-controlled Certificate Authority used to issue and manage trusted digital certificates without relying on an external certificate authority for the critical identity chain.",
...
export const userCertificateComponent: ComponentDefinition = {
  id: "user-certificate",
  name: "User Certificate",
  area: "identity-route",
  description:
    "Represents a digital certificate associated with the user and used to establish certificate-based identity during authentication.",
...
export const x509CertificateComponent: ComponentDefinition = {
  ...
  area: "identity-route",
  description:
    "Represents a standard X.509 digital certificate used to cryptographically verify the identity of a user, device, or service.",
...
export const certificateValidationComponent: ComponentDefinition = {
  id: "certificate-validation",
  name: "Certificate Validation",
  area: "identity-route",
  description:
    "Verifies that a certificate is valid before it is trusted, including checks such as certificate integrity, validity period, issuer, and trust chain.",
...
export const certificateRevocationCheckComponent: ComponentDefinition = {
  ...
  area: "identity-route",
  description:
    "Checks whether a previously issued certificate has been revoked and prevents revoked or compromised certificates from being trusted.",
...
export const otpComponent: ComponentDefinition = {
  ...
  area: "identity-route",
  description:
    "Represents a One-Time Password used as an additional authentication factor that is valid only for a single login or a short period of time.",
  icon: icon("otp"),
  isSaytecComponent: false,
  allowedAreaIds: ["identity-route"],
  configuration: [],
...
export const saytrustServerComponent: ComponentDefinition = {
  id: "saytrust-server",
  name: "sayTRUST Server",
  area: "access-enforcement",
  description:
    "Represents the central sayTRUST security server that evaluates identity, permissions, target applications, and access policies and can also enforce the resulting access decision.",
...
export const policyEngineComponent: ComponentDefinition = {
  ...
  area: "access-enforcement",
  description:
    "Evaluates contextual and security information to determine whether an access request should be allowed or denied according to defined organizational policies.",
...
export const clientPrivilegeManagementComponent: ComponentDefinition = {
  id: "client-privilege-management",
  name: "Client Privilege Management",
  area: "access-enforcement",
  description:
    "Controls and limits the privileges available to the client device or user so that unnecessary administrative or elevated permissions are not available during the access session.",
...
export const leastPrivilegeControlComponent: ComponentDefinition = {
  id: "least-privilege-control",
  name: "Least-Privilege Control",
  area: "access-enforcement",
  description:
    "Restricts access to the minimum permissions and resources required for the user's current task, reducing the impact of a compromised account or device.",
...
export const applicationAuthorizationComponent: ComponentDefinition = {
  id: "application-authorization",
  name: "Application Authorization",
  area: "access-enforcement",
  description:
    "Determines which specific applications the authenticated user is authorized to access and prevents access to applications that have not been explicitly approved.",
...
export const sessionRevocationComponent: ComponentDefinition = {
  id: "session-revocation",
  name: "Session Revocation",
  area: "access-enforcement",
  description:
    "Allows an active access session to be terminated when authorization changes, suspicious activity is detected, or the user is no longer permitted to continue the session.",
...
export const gatewayComponent: ComponentDefinition = {
  id: "gateway",
  name: "Gateway",
  area: "connection-method",
  description:
    "Represents the controlled entry point between the external client and protected resources. Its configuration determines whether it provides network-level or application-level access.",
  icon: icon("gateway"),
  isSaytecComponent: false,
  ...
  configuration: [
    ...
    bool(
      "protectedNetworkAddress",
      "Protected network address assigned",
      false,
    ),
  ],
  architecturalProperties: {},
...
export const networkConnectionComponent: ComponentDefinition = {
  id: "network-connection",
  name: "Network Connection",
  area: "connection-method",
  description:
    "Represents a connection that provides the client with access at the network level, potentially allowing the client to reach multiple systems or network resources.",
...
export const applicationConnectionComponent: ComponentDefinition = {
  id: "application-connection",
  name: "Application Connection",
  area: "connection-method",
  description:
    "Represents a connection that provides access only to a specific authorized application instead of exposing the broader protected network.",
...
export const ramApplicationTunnelComponent: ComponentDefinition = {
  id: "ram-application-tunnel",
  name: "RAM Application Tunnel",
  area: "connection-method",
  description:
    "Represents an application-specific secure tunnel whose connection state is established and maintained in RAM rather than as a conventional persistent network connection.",
...
export const encryptedRamComponent: ComponentDefinition = {
  id: "encrypted-ram",
  name: "Encrypted RAM",
  area: "connection-method",
  description:
    "Represents the protection of sensitive session and connection information while it is stored temporarily in memory using encryption.",
...
export const mutualTlsComponent: ComponentDefinition = {
  ...
  area: "connection-method",
  description:
    "Represents Mutual Transport Layer Security, where both the client and server authenticate each other using certificates before establishing a trusted encrypted connection.",
...
export const aes256EncryptionComponent: ComponentDefinition = {
  ...
  area: "connection-method",
  description:
    "Represents strong AES-256 encryption used to protect sensitive data and connection information against unauthorized reading.",
...
export const perfectForwardSecrecyComponent: ComponentDefinition = {
  ...
  area: "connection-method",
  description:
    "Uses independent temporary session keys so that compromise of long-term cryptographic material does not automatically expose previously protected sessions.",
...
export const virtualNetworkInterfaceComponent: ComponentDefinition = {
  id: "virtual-network-interface",
  name: "Virtual Network Interface",
  area: "connection-method",
  description:
    "Represents a virtual network adapter created on the client that can make the client participate in or interact with the protected network at the network level.",
...
export const corporateNetworkComponent: ComponentDefinition = {
  id: "corporate-network",
  name: "Corporate Network",
  area: "reachable-resources",
  description:
    "Represents broad access to the organization's internal network, where multiple protected systems and services may become reachable by the client.",
...
export const restrictedSubnetComponent: ComponentDefinition = {
  id: "restricted-subnet",
  name: "Restricted Subnet",
  area: "reachable-resources",
  description:
    "Represents network-level access limited to a specific internal subnet rather than the entire corporate network.",
...
export const internalWebApplicationComponent: ComponentDefinition = {
  ...
  area: "reachable-resources",
  description:
    "Represents a protected internal web application that the user can access without necessarily receiving access to the wider corporate network.",
...
export const virtualMachineComponent: ComponentDefinition = {
  ...
  area: "reachable-resources",
  description:
    "Represents a specific virtual machine that can be accessed as an authorized protected resource.",
...
export const externalIdentityProviderComponent: ComponentDefinition = {
  id: "external-identity-provider",
  name: "External Identity Provider",
  area: "third-party-systems",
  description:
    "Represents an external service that provides user identity information or identity assertions to the architecture. It may act as the primary identity source, a secondary identity signal, or a supporting identity service depending on its configuration.",
...
export const externalAuthenticationServiceComponent: ComponentDefinition = {
  ...
  area: "third-party-systems",
  description:
    "Represents an external service that directly performs or participates in the authentication decision used to determine whether the user may access protected resources.",
...
export const externalCloudServiceComponent: ComponentDefinition = {
  id: "external-cloud-service",
  name: "External Cloud Service",
  area: "third-party-systems",
  description:
    "Represents a cloud-hosted service operated by an external provider that the architecture depends on for application functionality, infrastructure, storage, or processing.",
...
export const externalMonitoringServiceComponent: ComponentDefinition = {
  ...
  area: "third-party-systems",
  description:
    "Represents an externally operated monitoring or security service that receives logs, telemetry, security events, or operational information from the architecture.",
...
export function getDefaultConfiguration(
  ...
  return Object.fromEntries(
    component.configuration.map((item) => [item.id, item.defaultValue]),
  );
}
